...
const Sidebar = () => {
  ...
  const navigation: Navigation[] = [
    ...
    },
    {
      ...
      current: pathname === "/todo" ? true : false,
    },
    {
      name: "In Progress",
      href: "/in-progress",
      icon: ClockIcon,
      current: pathname === "/in-progress" ? true : false,
    },
    {
      name: "Review",
      href: "/review",
      icon: ArrowPathIcon,
      current: pathname === "/review" ? true : false,
    },
    {
      name: "Done",
      href: "/done",
                ...
                <nav className="flex flex-col flex-1">
                  <ul role="list" className="flex flex-col flex-1 gap-y-7">
                    ...
                    <li className="mt-auto">
                      <a
                        href="#"
                        className="flex p-2 -mx-2 font-semibold text-gray-400 rounded-md group gap-x-3 text-sm/6 hover:bg-gray-800 hover:text-white">
                        <Cog6ToothIcon
                          aria-hidden="true"
                          className="size-6 shrink-0"
                        />
